...
export default function HeroExperience() {
  ...
  return (
    <div className="grid w-full max-w-6xl gap-8 rounded-[48px] bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.25),transparent_55%)] p-8 shadow-[0_40px_120px_rgba(2,6,23,0.75)] lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.85fr)] lg:p-12">
